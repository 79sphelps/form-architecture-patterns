  ...
  return (
    ...
    >
      <div className="p-4 bg-gray-50 border rounded-lg space-y-4">
        <LevelInfo level={5} title="Level 5 — Enterprise Pattern" description="Centralized form logic with reusable hooks." />
        <Concept concept="State machine via useReducer." />
        <Pros pros={['Scalable', 'Clean separation of concerns']} />
