  ...
  return (
    ...
    >
      <div className="p-4 bg-gray-50 border rounded-lg space-y-4">
        <LevelInfo level={5.5} title="Level 5.5 — Schema Validation" description="Validation logic defined in a schema." />
        <Concept concept="State machine via useReducer." />
        <Pros pros={['Reusable validation', 'Centralized rules']} />
        <Cons cons={['Indirection']} />
        <UseCase useCase="TBD" />
      </div> 
