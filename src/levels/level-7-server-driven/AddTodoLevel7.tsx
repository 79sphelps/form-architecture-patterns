...
export const AddTodoLevel7 = () => {
  ...
  //     <LevelInfo level="7" title="Server Driven UI" />
  ...
  return (
    ...
    >
      <div className="p-4 bg-gray-50 border rounded-lg space-y-4">
        <LevelInfo level={7} title="Level 7 — Server-Driven UI" description="Backend defines form structure." />
        <Concept concept="Backend defines form structure." />
        <Pros pros={['Dynamic forms', 'Backend-controlled UI']} />
